        ...
        <div class="w-[80%] mx-auto">
            ...
            <div class="my-10 max-w-5xl mx-auto ">
                ...
                <div class="flex flex-col justify-center my-10 items-center"
                    v-else-if="computedCompanyJobs && computedCompanyJobs.length== 0">
                    <h2 class="font-monts text-xl fext-semibold">You have not created any job yet</h2>
                    <c-button> Create Jobs</c-button>
                </div>
                <div class="flex justify-center my-10 items-center" v-else>
            ...
            <div class="my-10 max-w-5xl mx-auto ">
                ...
                <div class="flex flex-col justify-center my-10 items-center"
                    v-else-if="computedCompanyReviews && computedCompanyReviews.length== 0">
                    <h2 class="font-monts text-xl fext-semibold">You have not created any job yet</h2>
                    <c-button> Create Jobs</c-button>
                </div>
                <div class="flex justify-center my-10 items-center" v-else>
...
async function getReviews() {
    console.log(`${baseURL}api/hire/reviews`)
    try {
