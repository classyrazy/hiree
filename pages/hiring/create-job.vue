<template>
    <div>
        ...
        <div
            ...
            <p class="text-xl font-medium mt-5 text-gray-500 tracking-normal">Creating a job post gives you a ledge to
                share a link of your open position to any platform of your choice</p>
          ...
          w-full
         text-medium rounded-lg" full styleType="white" placeholder="Enter your company name"
          ...
          border
          p-4
         text-medium rounded-lg" v-model="formReactive.workModel.value" placeholder="Select one">
                        ...
                        <div class="form-group">
                            ...
                            mr-40
          w-full 
         text-medium rounded-lg" full styleType="white" placeholder="Enter your job title" :value="formReactive.title">
                            </c-input>
                        </div>
          ...
          border
          p-4
         text-medium rounded-lg" v-model="formReactive.jobLocationType.value">
                                <option disabled value="">Please select one</option>
                                <option value="remote">Remote</option>
                                <option value="onsite">On site</option>
                                <option value="hybrid">Hybrid</option>
                            </select>
                            <p class="text-[red] text-xs">{{ formReactive.jobLocationType.error }}</p>
                        </div>
                    </div>
                    ...
                    <div class="form-group flex flex-col mb-4">
                        ...
                        <p class="text-[red]" v-if="formReactive.description.error">{{ formReactive.description.error }}
                        </p>
                    </div>
